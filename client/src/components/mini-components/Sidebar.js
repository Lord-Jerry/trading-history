    ...
    return (
        <div className="hidden md:flex flex-col lg:w-64 p-5 bg-white shadow border-gray-500 sm:rounded-lg">
                ...
                <Link to="/dash/port-1" className="no-underline flex items-center mb-3  text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-900">
                    <svg className="h-6 w-6 fill-current mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M8 7h10V5l4 3.5-4 3.5v-2H8V7zm-6 8.5L6 12v2h10v3H6v2l-4-3.5z" fill-rule="nonzero" /></svg> Buy/Sell
                </Link>
