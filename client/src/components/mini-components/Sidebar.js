...
const Sidebar = () => {
    return (
        <div className="hidden md:flex flex-col lg:w-64 p-5 bg-white shadow border-gray-500 sm:rounded-lg">
                ...
                <Link to="/dash" class="no-underline flex items-center mb-3  text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-900">
                ...
                <Link to="/dash/port-1" class="no-underline flex items-center mb-3  text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-900">
                ...
                <Link to="/" class="no-underline flex items-center mb-3  text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-900">
