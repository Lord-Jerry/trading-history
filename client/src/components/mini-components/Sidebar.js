...
const Sidebar = () => {
    return (
        <div className="hidden lg:flex h-full lg:flex-col lg:w-64 p-5 bg-white shadow border-gray-500 lg:rounded-lg">
                ...
                <Link to="/dash" className="no-underline flex items-center mb-3  text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-900">
                                ...
                                <Link to="/" onClick={() => sessionStorage.removeItem('token')} className="no-underline flex items-center  text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-900">
