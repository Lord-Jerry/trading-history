...
const Sidebar = () => (
    <div className="hidden lg:flex h-full lg:flex-col lg:w-64 p-5 bg-white shadow border-gray-500 lg:rounded-lg">
        ...
        <div className="text-xl mb-1 leading-5 font-medium text-gray-900">Jane Cooper</div>
        <div className="text-sm leading-5 mb-5 text-gray-500">jane.cooper@example.com</div>
        <Link
            to="/dash"
            className="no-underline flex items-center mb-3  text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-900"
      >
      ...
      >
        ...
        <Link
            ...
            className="no-underline flex items-center  text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-900"
      >
            <svg className="h-6 w-6 fill-current mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
