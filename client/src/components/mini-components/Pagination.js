...
const Pagination = () => {
    return (
        <div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6 rounded-b overflow-hidden">
            <div class="hidde sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div className="hidden md:flex" >
                <p class="text-sm leading-5 text-gray-700 font-medium">
