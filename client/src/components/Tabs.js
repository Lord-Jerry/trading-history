    ...
    return (
            <div className="container mx-auto flex flex-wrap flex-col">
                <div className="flex w-full border-b text-sm bg-gray-50 pt-2">
                    <span onClick={() => handleActiveTab("open")} className={`sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b title-font font-medium inline-flex items-center leading-none ${openTab} cursor-pointer tracking-wider`}>
                    ...
                    <span onClick={() => handleActiveTab("closed")} className={`sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b title-font font-medium inline-flex items-center leading-none ${closeTab} cursor-pointer tracking-wider`}>
                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5 mr-3" viewBox="0 0 24 24">
