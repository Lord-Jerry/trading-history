    ...
    return (
        <div className="lg:flex lg:items-center lg:justify-between px-6 py-4 border-b">
          <div className="flex items-center flex-wrap min-w-0 text-gray-600">
            <a href="/" className="mr-5 text-xl flex items-center justify-around font-bold leading-7 rounded w-24 text-indigo-700 sm:leading-9 sm:truncate">
            ...
            <div className="sm:mt-5  md:mt-0 flex flex-col lg:flex-row flex-wrap items-cente space-x-0 md:space-x-8 space-y-2 md:space-y-0">
              ...
              <div className="text-sm leading-5 text-gray-500 flex-no-wrap">Entry Price: <span className="ml-4 text-gray-900">19 USDT</span> </div>
              <div className=" text-sm leading-5 text-gray-500"><span className="text-gray-900">24.6</span> Units</div>
              <div className="text-xs leading-5 font-semibold rounded-lg  text-green-800">
          ...
          <div className="mt-5 flex lg:mt-0 lg:ml-4">
            <span className=" shadow-sm rounded-md">
              <button type="button" onClick={e => toggleDropModal() } className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:text-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 active:text-gray-800 active:bg-gray-50 active:text-gray-800 transition duration-150 ease-in-out">
