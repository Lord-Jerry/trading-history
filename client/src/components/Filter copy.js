          ...
          <div className="flex-1 min-w-0 text-gray-600">
            ...
            <div className="mt-1 flex lg:inline-flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
              <div className="mt-2 flex items-center text-sm leading-5 sm:mr-6">
                <svg className="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-500 mr-1" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="mt-2 mr-4">
                <div className="text-sm leading-5 text-gray-500">Buy <span className="text-gray-900">19 USDT</span> </div>
            </div>
            <div className="">
