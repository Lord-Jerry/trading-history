    ...
    return (
        <div class="lg:flex lg:items-center lg:justify-between px-6 py-4 border-b">
          <div class="flex-1 min-w-0 text-gray-600">
            <h2 class="text-2xl inline-flex font-bold leading-7 text-gray-900 sm:text-3xl sm:leading-9 sm:truncate mr-8">
              FYI
            </h2>
            <div class="mt-1 flex lg:inline-flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
              <div class="mt-2 flex items-center text-sm leading-5 sm:mr-6">
                <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-500 mr-1" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div class="mt-2 mr-4">
                <div class="text-sm leading-5 text-gray-500">Buy <span className="text-gray-900">19 USDT</span> </div>
            </div>
            <div class="">
                <div class="text-sm leading-5 text-gray-900">28.5</div>
                <div class="text-sm leading-5 text-gray-500">Units</div>
            </div>
              <div class="mt-2 flex items-center text-sm leading-5 sm:mr-6">
                <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-500 mr-1" viewBox="0 0 20 20" fill="currentColor">
