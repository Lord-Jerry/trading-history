                ...
                <div className="flex justify-between items-center border-gray-100 py-4 md:justify-start md:space-x-10">
                    <div className="lg:w-0 md:flex-1">
                        <Link to="/" className="flex items-center">
                            ...
                            <div className=" text-indigo-700 hover:text-gray-900 text-3xl font-bold ml-3 md:ml-5">
                            tradelog
                            </div>
                      </Link>
                  </div>
                        ...
                        <div className="pt-5 pb-6 px-5 space-y-6">
                            ...
                            <div>
                                <nav className="grid row-gap-8">
                                    <Link
                                        to="/"
                                        className="px-3 py-2 flex items-center space-x-3 rounded-md hover:bg-gray-50 transition ease-in-out duration-150"
                                  >
                                        <svg
                                  ...
                                  >
                                      ...
                                      >
                                        ...
                                        <div className="text-base leading-6 font-medium text-gray-900">Sign in</div>
                                  </Link>
                                    <Link
                                        to="/pricing"
                                        className="px-3 py-2 flex items-center space-x-3 rounded-md hover:bg-gray-50 transition ease-in-out duration-150"
                                  ...
                                  >
                                      ...
                                      >
                                        ...
                                        <div className="text-base leading-6 font-medium text-gray-900">Dashboard</div>
                                  </Link>
                                    <Link
                                        to="/port-1"
                                        className="px-3 py-2 flex items-center space-x-3 rounded-md hover:bg-gray-50 transition ease-in-out duration-150"
                                  >
                                      ...
                                      >
                                        ...
                                        <div className="text-base leading-6 font-medium text-gray-900">Portfolio</div>
                                  </Link>
                              </nav>
                          </div>
                      </div>
