...
const Modal = ({
    hideModal, setHideModal, trade, tradeStatus, tradeStatusText,
}) => (
                ...
                <div className="flex flex-col items-center flex-wrap min-w-md text-gray-600">
                  ...
                  >
                    ...
                    <div className="pt-5 w-xl md:mt-0 flex flex-row flex-wrap items-cente">
                        ...
                        Entry Price:<span className="ml-4 text-gray-900">{trade.entryPrice}</span>
                      </div>
                        <div className="text-sm leading-5 text-gray-500 mr-5">
                            <span className="text-gray-900">{trade.noOfCoins}</span>
                        {' '}
                        Units
</div>
