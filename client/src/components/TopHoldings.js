    ...
    <div className="w-full mb-6 lg:mb-0 lg:w-1/2 px-4 flex flex-col">
        <div className="flex-grow flex flex-col bg-white border-t border-b sm:rounded sm:border shadow overflow-hidden">
            <div className="border-b flex">
                <h3 className="text-blue-dark pl-6 py-4 font-normal text-lg -mb-px">Top Holdings</h3>
          </div>
            <div className="flex-grow flex px-6 py-6 text-grey-darker items-center border-b -mx-4">
                ...
                <div className="flex w-3/5 md:w/12">
                    <div className="w-1/2 px-4">
                        ...
                        0.0010<span className="hidden md:inline">BTC</span>
                      </div>
                  </div>
                    <div className="w-1/2 px-4">
            ...
            <div className="flex-grow flex px-6 py-6 text-grey-darker items-center border-b -mx-4">
                ...
                <div className="flex w-3/5 md:w/12">
                    <div className="w-1/2 px-4">
                        <div className="text-right">
                        0.0000<span className="hidden md:inline">LTC</span>
                      </div>
                  </div>
                    <div className="w-1/2 px-4">
            ...
            <div className="flex-grow flex px-6 py-6 text-grey-darker items-center border-b -mx-4">
                ...
                <div className="flex w-3/5 md:w/12">
                    <div className="w-1/2 px-4">
                        <div className="text-right">
                        0.0000<span className="hidden md:inline">ETH</span>
                      </div>
                  </div>
                    <div className="w-1/2 px-4">
                        <div className="text-right text-grey">CA$0.00</div>
