          ...
          <div className="bg-blue-700 mb-10">
            <div className="container mx-auto px-4">
              <div className="flex items-center justify-between py-4">
                ...
                <Link to="/" className="w-auto text-center text-white text-2xl font-medium"> tradelog </Link>
                ...
                <div className="relative inline-block text-left">
                          <div className=" " onClick={e => toggleDrop()}>
                            <div className="flex items-center ml-2 hover hover:cursor">
                              ...
                              <span className="hidden md:inline-block text-white text-sm mx-2">Jane Cooper</span>
                              <div>
                          ...
                          <div className={`${hide} origin-top-right absolute right-0 mt-2 w-56 rounded-md shadow-lg`}>
                              ...
                              <div className="p-4" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                ...
                                <Link to="/" className="no-underline flex items-center  text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-900">
                                    <svg className="h-6 w-6 fill-current mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M8 7h10V5l4 3.5-4 3.5v-2H8V7zm-6 8.5L6 12v2h10v3H6v2l-4-3.5z" fillRule="nonzero" /></svg> 
                                    Logout
                                </Link>
                              </div>
                              </div>
