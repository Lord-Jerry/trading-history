                ...
                <main className="max-w-screen-xl sm:mt-12 px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div className="text-center mx-auto lg:mx-0 lg:text-left">
                            <h2 className="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                                Track and manage
                                <br className="xl:hidde" />
                                <span className="text-indigo-600">trades with ease</span>
                            </h2>
                            ...
                            <div className="mt-5 sm:mt-8 sm:flex flex-wrap sm:justify-center lg:justify-start">
                                ...
                                <Link to="/pricing" onClick={() => sessionStorage.setItem('token', "res.token")} 
                                ...
                                <div className="mt-3 sm:mt-0 sm:ml-3">
                                    <Link 
                                        to="/" onClick={() => sessionStorage.removeItem('token')} 
                                ...
                                {/* <button className="bg-gray-200 inline-flex py-3 px-5 rounded-lg items-center ml-4 hover:bg-gray-300 focus:outline-none">
                                    ...
                                    <span className="ml-4 flex items-start flex-col leading-none">
                                        <span className="text-xs text-gray-600 mb-1">Download for</span>
                                        <span className="title-font font-medium">Mobile Device</span>
                                    </span>
                                </button> */}
                            </div>
                        </div>
